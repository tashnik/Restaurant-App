...
struct AlertContext {
  ...
  static let invalidEmail = AlertItem(title: Text("Invalid Email"), message: Text("Not a valid email address"), dismissButton: .default(Text("Ok")))
  ...
  static let invalidUserData = AlertItem(title: Text("Profile Error"), message: Text("There was an error saving or retreiving your profile"), dismissButton: .default(Text("Ok")))
}
